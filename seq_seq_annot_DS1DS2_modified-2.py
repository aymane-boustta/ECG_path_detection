...
def run_program(args):
    ...
    def test_model():
        ...
        acc_avg, acc, sensitivity, specificity, PPV, F1_score_mean, F1_score, f1_micro, accuracy_micro = evaluate_metrics(sum_test_conf, y_pred_batch, y_true_batch)
        
        print('Average Accuracy is: {:>6.4f}. Averge F-score is: {:>6.4f}. Micro Accuracy is: {:>6.4f}. Micro F-score is: {:>6.4f} on test set'.format(acc, F1_score, acc_avg, F1_score_mean))
        ...
        return acc_avg, acc, sensitivity, specificity, PPV, confusion_matrix_result
    loss_track = []
    def count_prameters():
        ...
        if ckpt and ckpt.model_checkpoint_path:
            ...
            for epoch_i in range(epochs):
                ...
                if epoch_i%test_steps==0 or epoch_i==epochs - 1:
                    acc_avg, acc, sensitivity, specificity, PPV, confusion_matrix_result= test_model()

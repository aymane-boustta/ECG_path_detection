...
random.seed(654)
def read_mitbih(filename, max_time=100, classes= ['F', 'N', 'S', 'V' ], max_nlabel=100):
    def normalize(data):
    ...
    v = 1
    for i in range(1, 19):
        filename = "s2s_nsrdb_aami_{}.mat".format(i)
    ...
    #samples = samples['s2s_mitbih']
    #pdb.set_trace()
    #values = samples['s2s_mitbih'][0]['seg_values']
    #labels = samples['s2s_mitbih'][0]['seg_labels']
